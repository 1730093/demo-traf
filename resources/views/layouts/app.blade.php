                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @else
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item active">
                                <a href="{{ route('admin.asistencia.index') }}" class="nav-link i"
                                    style="color:white">{{ __('Asistencias') }}</a>
                            </li>
                            <li class="nav-item active">
                                <a href="{{ route('reporte.asistencia.index') }}" class="nav-link i"
                                    style="color:white">{{ __('Historial de asistencias') }}</a>
                            </li>
                            <li class="nav-item active">
                                <a href="{{ route ('admin.situaciones.index')  }}" class="nav-link i"
